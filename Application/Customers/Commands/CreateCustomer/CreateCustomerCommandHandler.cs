...
namespace Application.Customers.Commands.CreateCustomer
{
    internal sealed class CreateCustomerCommandHandler : ApiBaseHandler<CreateCustomerCommand, Unit>
    {
        ...
        public CreateCustomerCommandHandler(IUnitOfWork unitOfWork, IMapper mapper, IBaseRepository<Customer> customerRepository, ILogger<CreateCustomerCommandHandler> logger)
            : base(logger)
        {
